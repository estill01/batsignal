...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #------------------------------------------------------------------------------------------------------#
      [    :agendas_tab     ,    'Agendas'       ,    user_agendas_path    ,    true        ,    true        ],
      [    :users_tab       ,    'Users'         ,    users_path           ,    true        ,    true        ],
      [    :agents_tab      ,    'Agents'        ,    agents_path          ,    false       ,    false       ],
      [    :sessions_tab    ,    'Sessions'      ,    sessions_path        ,    false       ,    false       ],
      #------------------------------------------------------------------------------------------------------#
      #    TAB NAME         |    DISPLAY TEXT    |    PATH                 |    VISIBLE?    |    ENABLED?    #
      #------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #-------------------------------------------------------------#
      [    :agendas      ,    :all_actions    ,    :agendas_tab     ],
      [    :users        ,    :all_actions    ,    :users_tab       ],
      [    :agents       ,    :all_actions    ,    :agents_tab      ],
